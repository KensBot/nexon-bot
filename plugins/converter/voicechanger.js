...
exports.run = {
   ...
   async: async (m, {
      ...
      try {
         if (!m.quoted) return clips.reply(m.chat, Func.texted('bold', `🚩 Reply audio to use this command.`), m)
         ...
         ptt: true
            ...
            clips.reply(m.chat, Func.texted('bold', `🚩 Reply audio to use this command.`), m)
         }
      } catch (e) {
         console.log(e)
