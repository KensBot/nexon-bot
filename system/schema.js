module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'Copytight by'
      if (!('sk_author' in setting)) setting.sk_author = '© nexon.js'
